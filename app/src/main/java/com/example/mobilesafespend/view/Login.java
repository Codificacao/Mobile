package com.example.mobilesafespend.view;
...
import com.example.mobilesafespend.R;
import com.example.mobilesafespend.login.UsuarioController;
...
public class Login extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent cadastro = new Intent(Login.this, CadastroActivity.class);
